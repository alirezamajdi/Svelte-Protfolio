    ...
    let steps = [
        {
            ...
            href:"https://iphone-36f8617d.vercel.app/"
            },
        {
            name: "Flyksoft",
            icon: "fa-solid fa-transgender",
            href:"https://flyksoft.com/app/en"
            },
        {
            name: "Partnership",
            icon: "fa-solid fa-university",
            href:"https://ton-partnership-front.vercel.app/"
            },
    ];
...
<main class="flex flex-col flex-1 p-4">
    <section
        id="introPage"
        class="grid grid-cols-1 h-[50vh] md:h-[80vh] lg:grid-cols-2"
    >
        <div
            class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10"
        >
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm <span class="poppins text-violet-400">Alireza</span> Majdi
                <br />Svelte
                <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400"> favorite tech</span> includes JavaScript
                (React.JS or Svelte.JS and Next.JS), TailwindCSS, Node.js + Express.js & PostgreSQL
                or Firebase/Firestore!
            </p>
            
            <a
      href="https://www.linkedin.com/in/alireza-majdi/" 
  target="_blank" 
  rel="noopener noreferrer"
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p>
                    Titanum Store is a a merchanising store created with <strong
                        class="text-violet-400"
                        >React.js, Three.js</strong
                    >
                </p>
            </Step>
            <Step step={steps[1]}>
                <p>
                    Flyksoft is a comprehensive business management software,<strong
                        class="text-violet-400">Next.js</strong
                    >,
                    <strong class="text-violet-400">Node.js + Express.js</strong
                    >
                    & <strong class="text-violet-400">Stripe</strong> 
                </p>
            </Step>
            <Step step={steps[2]}>
                <p>
                    Partnership <strong class="text-violet-400"
                        >Reactjs & TailwindCSS</strong
                    >
                    web application, hosted on
                    <strong class="text-violet-400">Netlify</strong>, for communication on products
